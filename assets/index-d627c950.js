...
<meta property="og:title"
			content="myPresentation template">
<meta property="og:description"
			content="Шаблон презентации, альтернатива .pptx. Разрабатывается функциональная база для удобной кастомизации, но проект готов к использованию. Весь контент условный.">
<meta property="og:type"
			content="website">
<meta property="og:url"
			content="https://nazhdaque.github.io/my-presentation-template/">
<meta property="og:image"
			content="./images/demo/preview.jpg">
...
<meta name="description"
			content="Шаблон презентации, альтернатива .pptx. Разрабатывается функциональная база для удобной кастомизации, но проект готов к использованию. Весь контент условный.">
<title>myPresentation template</title>
<link rel="icon"
			type="image/svg+xml"
			href="/images/demo/vite.svg">`,oe=`<div class="main-header__group">
	<a href="https://hh.ru/resume/1b5be24eff08e1e5cd0039ed1f5270454c4b49"
		 class="brand-logo logo-link"
		 aria-label="home">
		<img class="logo-link__img"
				 src="/images/hh.svg"
				 alt="brand-logo">
	</a>
	...
	<nav class="md--d-none"
		...
		<ul class="nav-links">
			<li><a href="#"
					 class="nav-links__link">link</a></li>
			<li><a href="#"
					 class="nav-links__link">link</a></li>
			<li><a href="#"
					 class="nav-links__link">link</a></li>
	...
	<button class="sidebar-toggle"
		...
		<span class="sidebar-toggle-img"></span>
	</button>
</div>`,de=`<li class="sidebar-item">
		...
		<ol class="sidebar-item__links">
			<li>
				<a href="#"
					...
					<span class="ellipsis"
								tabindex="-1">Lorem ipsum dolor.</span>
				</a>
			</li>
...
</li>`,ce=`<li class="swiper-slide slide-1">
...
</li>`,ue=`<li class="swiper-slide slide-2">
	<div class="layout-center">
		<div class="slide-content">
			...
			<ol class="flex-x list-w-arrows list-w-arrows--right">
				<li class="slave-1">
					<div class="li-head">
...
</li>`,fe=`<li class="swiper-slide slide-3">
	<div class="layout-center">
		<div class="slide-content">
...
</li>`,pe=`<li class="swiper-slide slide-4">
	<div class="layout-center">
		<div class="slide-content">
			<div class="slide-bg spike"></div>
			<h2 class="heading fs-xl width-x">Lorem ipsum dolor sit</h2>

			<ul class="grid-x cards-x cards-1 cards-w-rounded-img"
...
</li>`,he=`<li class="swiper-slide slide-5">
	<div class="layout-center">
		<div class="slide-content">
...
</li>`,me=`<li class="swiper-slide slide-6">
	<div class="layout-center">
		<div class="slide-content">
			<div class="slide-bg spike"></div>
...
</li>`,ve=`<li class="swiper-slide slide-7">
	<div class="layout-center">
		<div class="slide-content">
			<div class="slide-bg diag w-img"></div>
		</div>
	</div>
</li>`,ge=`<li class="swiper-slide slide-8">
	<div class="layout-center">
		<div class="slide-content">
			<div class="slide-bg zigzag w-img"></div>
		</div>
	</div>
</li>`,we=`<li class="swiper-slide slide-9">
	<div class="layout-center">
		<div class="slide-content">
			<div class="slide-bg waves w-img"></div>
		</div>
	</div>
</li>`,be=`<li class="swiper-slide slide-10">
	<div class="layout-center">
		<div class="slide-content">
			<div class="slide-bg spike w-img"></div>
			<div class="slide-bg spike"></div>
