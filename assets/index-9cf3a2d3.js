...
</li>`,de=`<li class="swiper-slide slide-1">
...
</li>`,ce=`<li class="swiper-slide slide-2">
	<div class="layout-center">
		<div class="slide-content">
...
</li>`,ue=`<li class="swiper-slide slide-3">
	<div class="layout-center">
		<div class="slide-content">
...
</li>`,fe=`<li class="swiper-slide slide-4">
	<div class="layout-center">
		<div class="slide-content">
...
</li>`,pe=`<li class="swiper-slide slide-5">
	<div class="layout-center">
		<div class="slide-content">
...
</li>`,he=`<li class="swiper-slide slide-6">
	<div class="layout-center">
		<div class="slide-content">
			<div class="slide-bg spike"></div>
...
</li>`,me=`<li class="swiper-slide slide-7">
	<div class="layout-center">
		<div class="slide-content">
			<div class="slide-bg diag w-img"></div>
		</div>
	</div>
</li>`,ve=`<li class="swiper-slide slide-8">
	<div class="layout-center">
		<div class="slide-content">
			<div class="slide-bg zigzag w-img"></div>
		</div>
	</div>
</li>`,ge=`<li class="swiper-slide slide-9">
	<div class="layout-center">
		<div class="slide-content">
			<div class="slide-bg waves w-img"></div>
		</div>
	</div>
</li>`,we=`<li class="swiper-slide slide-10">
	<div class="layout-center">
		<div class="slide-content">
			<div class="slide-bg spike w-img"></div>
			<div class="slide-bg spike"></div>
...
</li>`,be=`<li class="swiper-slide slide-11">
	<div class="layout-center">
		<div class="slide-content">
			<div class="slide-bg circle w-img"></div>
		</div>
	</div>
</li>`,ye=`<div class="main-footer__group">
	<a href="#"
